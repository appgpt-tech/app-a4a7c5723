...
const DeliveryBoyTitle = () => {
  const record = useRecordContext();
  return <span>DeliveryBoy {record ? `"${record.Name}"` : ''}</span>;
};
...
export const DeliveryBoyEdit = () => (
  <Edit title={<DeliveryBoyTitle />}>
    <SimpleForm>
...
export const DeliveryBoyCreate = () => (
  <Create>
    <SimpleForm>
      <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 5 }}>
        <Grid item xs={4}>
