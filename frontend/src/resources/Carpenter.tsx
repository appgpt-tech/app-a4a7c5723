...
const CarpenterTitle = () => {
  const record = useRecordContext();
  return <span>Carpenter {record ? `"${record.Name}"` : ''}</span>;
};

export const CarpenterList = () => (
...
export const CarpenterEdit = () => (
  <Edit title={<CarpenterTitle />}>
    <SimpleForm>
